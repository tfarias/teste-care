var Layout=function() {
    var a="layouts/layout/img/", t="layouts/layout/css/", i=App.getResponsiveBreakpoint("md"), s=[], o=[], n=function() {
            var e, a=$(".page-content"), t=$(".page-sidebar"), s=$("body");
            if(s.hasClass("page-footer-fixed")===!0&&s.hasClass("page-sidebar-fixed")===!1) {
                var o=App.getViewPort().height-$(".page-footer").outerHeight()-$(".page-header").outerHeight(), n=t.outerHeight();
                ...
                if(s.hasClass("page-sidebar-fixed"))e=d(), s.hasClass("page-footer-fixed")===!1&&(e-=$(".page-footer").outerHeight());
                    ...
                    var r=$(".page-header").outerHeight(), l=$(".page-footer").outerHeight();
        ...
        , r=function(e, a) {
            var t=location.hash.toLowerCase(), s=$(".page-sidebar-menu");
            ...
            $(".page-sidebar-mobile-offcanvas .responsive-toggler").click(function() {
                    ...
                    if(!(App.getViewPort().width>=i&&!$(".page-sidebar-menu").attr("data-initialized")&&$("body").hasClass("page-sidebar-closed")&&1===a.parent("li").parent(".page-sidebar-menu").size())) {
                        ...
                        if(!(App.getViewPort().width>=i&&1===a.parents(".page-sidebar-menu-hover-submenu").size())) {
                            ...
                            var s=a.parent().parent(), o=a, r=$(".page-sidebar-menu"), l=a.next(), d=r.data("auto-scroll"), p=parseInt(r.data("slide-speed")), c=r.data("keep-expanded");
    ...
    return {
        ...
        , loadAjaxContent:function(e, a) {
            ...
            App.startPageLoading( {
                    ...
                    type:"GET", cache:!1, url:e, dataType:"html", success:function(e) {
                        App.stopPageLoading();
                        for(var i=0;
                            i<s.length;
                            i++)s[i].call(e);
